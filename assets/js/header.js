(function() {
    ...
    fixLink.href = pathPrefix + "assets/css/responsive-fixes.css";
    fixLink.id = "responsiveFixesStylesheet";
    const oldFix = document.getElementById("responsiveFixesStylesheet");
